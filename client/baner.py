...
#  _______  __   __  __   __  ___   ______   
# |       ||  | |  ||  | |  ||   | |    _ |  
# |    _  ||  |_|  ||  |_|  ||   | |   | ||  
# |   |_| ||       ||       ||   | |   |_||_ 
# |    ___||_     _||       ||   | |    __  |
...
:!:         :!:     ::!!:!   :!:  :!:  !:!  
 ...
 :           :        :      :     :   : :  
    ...
    """)+"       " + Colour.yellow("Pyvir") +
           "(" +Colour.red("v0.1")+")" + Colour.red(" - 2025") + 
            "\n" + Colour.purple("GitHub: https://github.com/Pyrax-lab/Pyvir") + "\n"+"\n" + Colour.red("Using malware, including viruses\nand other malicious software, should\nonly be done on your personal computer\nand solely for educational purposes.") )
